...
X1 = np.array([[1, 1, 1, 1], [np.nan, np.nan, 3, 2],
              [1, 2, 2, 1], [2, 2, 2, 2]])

X1_res = np.array([[1., 1., 1., 1.], [2., 2., 3., 2.],
                  [1., 2., 2., 1.], [2., 2., 2., 2.]])
...
def test_em_sampler_convert_numpy(df: NDArray) -> None:
    ...
    assert type(
        em_sampler.ImputeEM()._convert_numpy(df)) == np.ndarray



imputations_var = [np.array([1,2,3,3]),np.array([1,2,3,3]),np.array([1,2,3,3]),np.array([1,2,3,3]),np.array([1,2,3,3]),np.array([1,2,3,3])]
mu_var = [np.array([1,2,3,3]),np.array([1,2,3,3]),np.array([1,2,3,3]),np.array([1,2,3,3]),np.array([1,2,3,3]),np.array([1,2,3,3])]
cov_var = [np.array([1,2,3,3]),np.array([1,2,3,3]),np.array([1,2,3,3]),np.array([1,2,3,3]),np.array([1,2,3,3]),np.array([1,2,3,3])]
n_iter_var = 11
...
def test_em_sampler_check_convergence(imputations: List[np.ndarray],mu:List[np.ndarray],cov:List[np.ndarray],n_iter:int)->None:
...
X_shifted_ystd = np.array([[ 1.,  2.,  4.,  5., np.nan, np.nan, np.nan, np.nan],[ 6.,  7.,  8.,  9.,  1.,  2.,  4.,  5.]])
X_shifted_tmrw = np.array([[ 1.,  2.,  4.,  5.,  6.,  7.,  8.,  9.],[ 6.,  7.,  8.,  9., np.nan, np.nan, np.nan, np.nan]])
...
X1_res = np.array([[1., 1., 1., 1.], [2., 2., 3., 2.],[1., 2., 2., 1.], [2., 2., 2., 2.]])
